...
async def startup() -> None:
    ...
    if is_real:
        ...
        test_brain = robot_brains.get_robot_brain('placeholder')
    ...
    async def main_page():
        ...
        def update_test_brain(new_brain_name):
            ...
            print(f"Switching to brain: {brain_name}")  # Debug-Ausgabe
            test_brain = robot_brains.get_robot_brain(brain_name)
            print(f"New test_brain has {len(test_brain.modules)} modules")  # Neue Debug-Ausgabe
            update_module_ui()
